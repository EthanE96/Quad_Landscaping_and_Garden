...
namespace api.Data
{
    public class Database
    {
        ...
        public Database()
        {
            string server = Environment.GetEnvironmentVariable("quadLG_database_host");
            string name = Environment.GetEnvironmentVariable("quadLG_database_name");
            string port = Environment.GetEnvironmentVariable("quadLG_database_port");
            string username = Environment.GetEnvironmentVariable("quadLG_database_username");
            string password = Environment.GetEnvironmentVariable("quadLG_database_password");
